...
public:
	...
	virtual void init(string id, int lev, int x, int y, int z, int vc, int ports, int numpse, int buff_size,  string n);
	...
	void unblock(int in, int outport);
	...
	int** xbar; // xbar[outport][inport]
	int** xbarIn; // xbar[inport][outport]
